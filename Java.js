...
let emp12 = new Designer("Dima1 ", "Yaroshinskiy", 1000, 11, 0.8);
let emp11 = new Designer("Dima2 ", "Yaroshinskiy", 1000, 11, 0.8);
let emp5 = new Developer("Dima3 ", "Yaroshinskiy", 1000, 11);
let emp6 = new Developer("Dima4 ", "Yaroshinskiy", 1000, 11);
let emp7 = new Developer("Dima5 ", "Yaroshinskiy", 1000, 11);
let emp8 = new Designer("Dima6 ", "Yaroshinskiy", 1000, 11, 0.8);
let emp9 = new Designer("Dima7 ", "Yaroshinskiy", 1000, 11, 0.8);
let emp10 = new Developer("Dima8 ", "Yaroshinskiy", 1000, 11);
let emp2 = new Developer("Anot", "Kugut", 1500, 5);
let emp4 = new Developer("Maks", "Poizdnik", 1300, 6);
let emp13 = new Developer("Andriy ", "Koshmak", 1300, 6);
let emp3 = new Manager("Danilo", "Kulinyak", 2000, 8, [emp13,emp11, emp2, emp4, emp10, emp9, emp8, emp7, emp6, emp5, emp12]);
